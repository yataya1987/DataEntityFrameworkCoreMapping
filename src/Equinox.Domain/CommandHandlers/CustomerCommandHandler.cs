...
namespace Equinox.Domain.CommandHandlers
{
        ...
        IRequestHandler<RemoveCustomerCommand, bool>
    {
        ...
        public CustomerCommandHandler(ICustomerRepository customerRepository,  IUnitOfWork uow,IMediatorHandler bus,INotificationHandler<DomainNotification> notifications) :base(uow, bus, notifications)
        {
